...
locals {
  mig_cfg = {
    "mig01" = {
      ...
      startup_script = file("./scripts/startup-script01.sh")
      ...
      tags = ["allow-ssh-iap", "mig-01", "lb-web-hc"]
    },
    "mig02" = {
      machine_type         = "e2-small"
      source_image         = "debian-11"
      ...
      startup_script = file("./scripts/startup-script02.sh")
      ...
      tags = ["allow-ssh-iap", "mig-02", "lb-web-hc"]
    },
